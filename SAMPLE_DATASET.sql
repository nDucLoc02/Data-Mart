...
IF DB_ID ('[LOCKHEED_MARTIN_SYNAPSE]') IS NOT NULL DROP DATABASE [LOCKHEED_MARTIN_SYNAPSE]


CREATE DATABASE [LOCKHEED_MARTIN_SYNAPSE]
GO
...
IF OBJECT_ID ('[LOCKHEED_MARTIN_SYNAPSE].[Production].[Categories]','U') IS NOT NULL DROP TABLE [LOCKHEED_MARTIN_SYNAPSE].[Production].[Categories]


CREATE TABLE [LOCKHEED_MARTIN_SYNAPSE].[Production].[Categories] 
			(
...
INSERT INTO [LOCKHEED_MARTIN_SYNAPSE].[Production].[Categories] ([CategoryID],[CategoryName],[Description]) 
...
IF OBJECT_ID ('[LOCKHEED_MARTIN_SYNAPSE].[Sales].[Customers]','U') IS NOT NULL DROP TABLE [LOCKHEED_MARTIN_SYNAPSE].[Sales].[Customers]

CREATE TABLE [LOCKHEED_MARTIN_SYNAPSE].[Sales].[Customers]
             (
...
INSERT INTO [LOCKHEED_MARTIN_SYNAPSE].[Sales].[Customers] ([CustomerID],[CustomerName],[ContactName],[Address],[City],[PostalCode],[Country])
...
IF OBJECT_ID ('[LOCKHEED_MARTIN_SYNAPSE].[HR].[Employees]','U') IS NOT NULL DROP TABLE [LOCKHEED_MARTIN_SYNAPSE].[HR].[Employees]


CREATE TABLE [LOCKHEED_MARTIN_SYNAPSE].[HR].[Employees] 
					(
...
INSERT INTO [LOCKHEED_MARTIN_SYNAPSE].[HR].[Employees] ([EmployeeID],[LastName],[FirstName],[BirthDate],[Photo],[Notes]) 
...
IF OBJECT_ID ('[LOCKHEED_MARTIN_SYNAPSE].[Sales].[Orders]','U') IS NOT NULL DROP TABLE [LOCKHEED_MARTIN_SYNAPSE].[Sales].[Orders] 


CREATE TABLE [LOCKHEED_MARTIN_SYNAPSE].[Sales].[Orders]
							(
								orderid        INT          ,
								custid         INT          NULL,
								empid          INT          NOT NULL,
								...
								shipcity       NVARCHAR(200) NOT NULL,
								shipregion     NVARCHAR(200) NULL,
								shippostalcode NVARCHAR(200) NULL,
								shipcountry    NVARCHAR(200) NOT NULL
							)
INSERT INTO [LOCKHEED_MARTIN_SYNAPSE].[Sales].[Orders](orderid, custid, empid, orderdate, requireddate, shippeddate, shipperid, freight, shipname, shipaddress, shipcity, shipregion, shippostalcode, shipcountry)
...
IF OBJECT_ID ('[LOCKHEED_MARTIN_SYNAPSE].[Sales].[OrderDetails]','U') IS NOT NULL DROP TABLE [LOCKHEED_MARTIN_SYNAPSE].[Sales].[OrderDetails]


CREATE TABLE [LOCKHEED_MARTIN_SYNAPSE].[Sales].[OrderDetails]
								(
...
INSERT INTO [LOCKHEED_MARTIN_SYNAPSE].[Sales].[OrderDetails](orderid, productid, unitprice, qty, discount)
...
IF OBJECT_ID ('[LOCKHEED_MARTIN_SYNAPSE].[Production].[Products]','U') IS NOT NULL DROP TABLE [LOCKHEED_MARTIN_SYNAPSE].[Production].[Products]



CREATE TABLE [LOCKHEED_MARTIN_SYNAPSE].[Production].[Products] 
									(
										PRODUCTID INT NOT NULL 
...
INSERT INTO [LOCKHEED_MARTIN_SYNAPSE].[Production].[Products] (PRODUCTID,PRODUCTNAME,SUPPLIERID,CATEGORYID,UNIT,PRICE) 
...
IF OBJECT_ID ('[LOCKHEED_MARTIN_SYNAPSE].[Production].[Suppliers]','U') IS NOT NULL DROP TABLE [LOCKHEED_MARTIN_SYNAPSE].[Production].[Suppliers]




CREATE TABLE [LOCKHEED_MARTIN_SYNAPSE].[Production].[Suppliers](
														     SUPPLIERID INT NOT NULL 
...
INSERT INTO [LOCKHEED_MARTIN_SYNAPSE].[Production].[Suppliers] (SUPPLIERID,SUPPLIERNAME,CONTACTNAME,[ADDRESS],CITY,POSTALCODE,COUNTRY,PHONE) 
...
UPDATE [LOCKHEED_MARTIN_SYNAPSE].[Sales].[Orders]
SET orderdate = DATEADD(YEAR,14,orderdate)
   ,requireddate = DATEADD(YEAR,14,requireddate)
   ,shippeddate = DATEADD(YEAR,14,shippeddate)
FROM [LOCKHEED_MARTIN_SYNAPSE].[Sales].[Orders]

ALTER TABLE [LOCKHEED_MARTIN_SYNAPSE].[Sales].[Orders] 
ADD [YEAR_SCLICER] NVARCHAR(50)  
   ,[FULL_PERIOD] NVARCHAR(50)
   ,[PERIOD] NVARCHAR(50)
   ,[MONTH_ORDER_SCLICER] INT


UPDATE [LOCKHEED_MARTIN_SYNAPSE].[Sales].[Orders]
SET [YEAR_SCLICER] = YEAR(orderdate)

UPDATE [LOCKHEED_MARTIN_SYNAPSE].[Sales].[Orders]
SET [FULL_PERIOD] = CAST(orderdate AS DATE)

UPDATE [LOCKHEED_MARTIN_SYNAPSE].[Sales].[Orders]
SET [PERIOD] = CONVERT(NVARCHAR(7),orderdate,23)

UPDATE [LOCKHEED_MARTIN_SYNAPSE].[Sales].[Orders]
SET [MONTH_ORDER_SCLICER] = MONTH(orderdate)
